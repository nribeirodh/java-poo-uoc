...
public class Player {
    ...
    public Player(String name, int level, LocalDate creationDate, int experience, int gold, double healthRegenPerSec, double criticalPct, double dodgePct, String honorTitle, PlayerRace playerRace, String petName, int petLevel, LocalDate petBirthday, int petLoyalty, int petStamina, boolean petlsAggressive) {
        setName(name);
        setLevel(level);
        setCreationDate(creationDate);
        setExperience(experience);
